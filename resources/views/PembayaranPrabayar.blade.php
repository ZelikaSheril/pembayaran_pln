<x-app-layout>
    <div class="flex items-center justify-center mt-7 mb-7">
        <div class="bg-white border border-gray-300 rounded-xl shadow-lg w-[400px]" x-data="pembayaranPrabayar()">
            ...
            <div class="p-6 space-y-2">
                ...
                <div class="grid grid-cols-3">
                    ...
                    <span class="text-center">:</span>
                    <span class="text-left">{{ now()->format('d/m/Y') }}</span> 
                </div>                
                
                <div class="grid grid-cols-3">
                    <span><strong>Stand Meter</strong></span>
                    <span class="text-center">:</span>
                    <span class="text-left">{{ $standMeter ?? 'N/A' }}</span>
                </div>
                
                <div class="grid grid-cols-3">
                    <span><strong>Nominal</strong></span>
                    <span class="text-center">:</span>
                    <span class="text-left">Rp {{ number_format($nominal, 0, ',', '.') }}</span>
                </div>
                ...
                <div class="grid grid-cols-3">
                    ...
                    <span class="text-center">:</span>
                    <span class="text-left break-words">{{ $token }}</span>
                ...
                <div class="grid grid-cols-3">
                    ...
                    <div class="grid grid-cols-3 font-semibold">
                        ...
                        <span class="text-center">:</span>
                        <span class="text-left">Rp {{ number_format($totalBayar ?? 0, 0, ',', '.') }}</span>
                    </div>
    ...
    function pembayaranPrabayar() {
        return {
            ...
            bayarPrabayar() {
                ...
                let totalBayar = parseFloat("{{ $totalBayar ?? 0 }}") || 0;
